...
export const getItemName = (state, id) => sales.getItemName(state.salesForm, id);
export const getItemRate = (state, id) => sales.getItemRate(state.salesForm, id);
export const getItemQty = (state, id) => sales.getItemQty(state.salesForm, id);
export const getOrderDetail = (state, name) => sales.getOrderDetail(state.salesForm, name);
