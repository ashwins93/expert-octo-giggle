  ...
  deliveryDetailChange
    ...
    <React.Fragment>
      ...
      <FormGroup className="mt-3" row>
        ...
        <Col sm={3}>
          <Input id="supply" value={supply} onChange={e => deliveryDetailChange('supply', e.target.value)} />
        </Col>
      ...
      <FormGroup row>
        ...
        <Col sm={3}>
          <Input
            ...
            onChange={e => deliveryDetailChange('pendingPayments', e.target.value)}
          />
        </Col>
      </FormGroup>
      <Row>
...
export default connect(mapStateToProps, { deliveryDetailChange })(DeliveryDetails);